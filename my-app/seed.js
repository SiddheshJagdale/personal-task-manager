...
var pg_1 = require("pg");
var schema_1 = require("@/db/schema"); // Update this import path if necessary
...
function seedDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var userId1, userId2, projectId1, projectId2, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    projectId1 = (0, uuid_1.v4)();
                    projectId2 = (0, uuid_1.v4)();
                ...
                case 3:
                    ...
                    // Insert Tasks
                    return [4 /*yield*/, db.insert(schema_1.tasks).values([
                            {
                                id: (0, uuid_1.v4)(),
                                title: "Task 1",
